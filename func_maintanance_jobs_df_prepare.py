...
def maintanance_jobs_df_prepare(calculation_start_mode):
  ...
  maintanance_jobs_short = maintanance_jobs_complete_df.loc[:, ['eo_code','maintanance_name', 'maintanance_start_date', 'maintanance_finish_date','days_between_maintanance','next_maintanance_datetime', 'downtime_plan', 'man_hours', 'year', 'month']]
